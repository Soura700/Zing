...
function App() {
  ...
  const tourSteps = [
    {
      ...
      content:
        "This is the navbar. It allows you to navigate through the application.",
    },
    {
      target: `.${leftBarStyles.container}`,
      content:
        "This is the left bar. It provides additional navigation and options.",
    },
    {
  ...
  const handleTourComplete = () => {
    // Remove isNewUser flag from local storage
